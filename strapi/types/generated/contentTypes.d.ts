...
export interface ApiNewMessageNewMessage extends Schema.CollectionType {
  collectionName: 'new_messages';
  info: {
    singularName: 'new-message';
    pluralName: 'new-messages';
  ...
  attributes: {
    newMessages: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::new-message.new-message',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiNewMessageUserNewMessageUser extends Schema.CollectionType {
  collectionName: 'new_message_users';
  info: {
    singularName: 'new-message-user';
    pluralName: 'new-message-users';
    displayName: 'newMessageUser';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    newMessagesUser: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::new-message-user.new-message-user',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::new-message.new-message': ApiNewMessageNewMessage;
      'api::new-message-user.new-message-user': ApiNewMessageUserNewMessageUser;
